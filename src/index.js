...
export class Map extends React.Component {
  ...
  loadMap() {
    if (this.props && this.props.google) {
      ...
      var mapTypeId = mapTypeIds[mapTypeFromProps]
      ...
      var styledMap = this.props.mapStyles || [];
      var styleName = 'styled_map';
      if (styledMap.length) {
      ...
      if (styledMap.length) {
        var styledMapType = new google.maps.StyledMapType(styledMap, {name: styleName});
